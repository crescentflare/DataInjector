//
//  SnakeToCamelCaseInjectorOld.swift
//  DataInjector Pod
//
...
open class SnakeToCamelCaseInjectorOld: BaseInjectorOld {
    ...
    override open func appliedInjection(targetData: Any, subTargetData: Any?, referencedData: Any? = nil, subReferencedData: Any? = nil) -> Any {
        return SnakeToCamelCaseInjectorOld.changedCase(onData: targetData)
    }
