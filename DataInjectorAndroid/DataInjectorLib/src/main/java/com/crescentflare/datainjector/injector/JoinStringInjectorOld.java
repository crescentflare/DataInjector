 ...
 */
public class JoinStringInjectorOld extends BaseInjectorOld
{
    // ---
    // Members
    // ---
    ...
    public JoinStringInjectorOld()
    {
    }

    public JoinStringInjectorOld(String item, List<String> fromItems)
    {
        this.item = item;
        this.fromItems = fromItems;
    }

    public JoinStringInjectorOld(String item, List<String> fromItems, String delimiter)
    {
        this.item = item;
        this.fromItems = fromItems;
    ...
    public JoinStringInjectorOld(String item, List<String> fromItems, String delimiter, boolean removeOriginals)
    {
        this.item = item;
        this.fromItems = fromItems;
        this.delimiter = delimiter;
